...
class Data_Spider():
    ...
    def spider_note(self, note_url: str, cookies_str: str, proxies=None):
        ...
        note_info = None
        try:
            success, msg, resp_data = self.xhs_apis.get_note_info(note_url, cookies_str, proxies)
            if success and resp_data.get('data', {}).get('items'):
                note_info = resp_data['data']['items'][0]
                note_info['url'] = note_url
                note_info = handle_note_info(note_info)
            else:
                success = False
                msg = resp_data.get('msg', msg) if resp_data else msg
...
if __name__ == '__main__':
    ...
    notes = [
        r'https://www.xiaohongshu.com/explore/63648f3b000000000601fa6f?xsec_token=ABUej76t9EIET81HhTQZ5HAXeH0HC1w8PD4f4IKtprTr4=&xsec_source=pc_user',
    ]
